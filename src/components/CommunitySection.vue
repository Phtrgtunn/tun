    ...
    <div class="max-w-[1920px] mx-auto">
      ...
      <div class="mb-8">
        ...
        <div class="relative group/scroll">
          ...
          <div ref="topScrollRef" class="flex gap-3 overflow-x-auto scrollbar-hide py-2 scroll-smooth">
            <div 
              v-for="(comment, index) in topComments" 
              :key="comment.id" 
              class="flex-none w-[300px] rounded-xl p-4 border border-gray-700/30 hover:border-yellow-400/50 transition-all duration-300 cursor-pointer hover:scale-[1.02] hover:shadow-xl hover:shadow-yellow-400/10 relative overflow-hidden group"
            >
