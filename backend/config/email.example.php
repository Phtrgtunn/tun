 ...
 * 2. Thay 'your-email@gmail.com' bằng email Gmail của bạn
 * 3. Thay 'your-app-password' bằng App Password từ Gmail
 * 
 * Cách tạo App Password:
 * - Truy cập: https://myaccount.google.com/apppasswords
 * - Chọn Mail → Windows Computer → Generate
 * - Copy mật khẩu 16 ký tự (bỏ dấu cách)
 */
...
class EmailService {
    ...
    public function __construct() {
        ...
        try {
            ...
            // ⬇️ THAY ĐỔI 2 DÒNG NÀY ⬇️
            $this->mail->Username   = 'your-email@gmail.com';     // ← Thay email của bạn
            $this->mail->Password   = 'your-app-password';        // ← Thay App Password (16 ký tự, không dấu cách)
            
            $this->mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $this->mail->Port       = 587;
            
            // ⬇️ THAY ĐỔI DÒNG NÀY ⬇️
            $this->mail->setFrom('your-email@gmail.com', 'HTHREE Film');  // ← Thay email của bạn
